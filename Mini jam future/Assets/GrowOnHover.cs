...
public class GrowOnHover : MonoBehaviour
{
    ...
    public void OnMouseOver()
    {
        ...
        LeanTween.scale(gameObject, new Vector3(gameObject.transform.localScale.x + 0.3f, gameObject.transform.localScale.y + 0.3f, gameObject.transform.localScale.z + 0.3f), 0.3f);
    }
